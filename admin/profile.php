                      ...
                      <div class="row">
                          <div class="col-md-3">
                            <div class="card card-primary card-outline">
                              <?php
                                $u_id      = $_SESSION['id'];
                                $sql_1   = "SELECT * FROM user WHERE id = '$u_id' ";
                                ...
                                ?>
                                  <div class="post">
                                    ...
                                    <div class="user-block">
                                      <img class="img-circle img-bordered-sm" src="img/post/<?php echo $image; ?>" alt="user image">
                                      <span class="username">
            ...
            if ( isset($_POST['update']) ){
              ...
              if (empty($formerror)) {
                if (!empty($imagename) ) {
                  ...
                  $sql = "UPDATE user SET name='$name', email='$email', phone='$phone', address='$address',gender='$gender', image='$imgname' WHERE id = '$id' ";
                  ...
                  $sql = "UPDATE user SET name='$name', email='$email', phone='$phone', address='$address', gender='$gender' WHERE id = '$id' ";
                  $updateUser = mysqli_query($db, $sql);
                  if ( $updateUser ){
                    header("Location: profile.php");
                  }
